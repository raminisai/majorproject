...
import { get_phrases } from "./textAnalytics/keyPhrasesAnalyics.js";
import { get_language } from "./textAnalytics/languageAnalytics.js";
import { get_sentiment } from "./textAnalytics/sentimentAnalytics.js";
import "./textAnalytics/entityAnalytics";
    ...
    case 39:
      ...
      if (i < 5) {
        if (!noteContent.length) {
          ...
          let key = i;
          if (!documents["documents"][i]) key = -1;
          ...
          if (key == -1) {
            ...
            documents["documents"][key]["text"] = noteContent;
          }
        ...
        console.log(documents);
        console.log("%c" + get_language(documents), "color: pink");
      }
      break;
    case 37:
      if (i > 0) {
